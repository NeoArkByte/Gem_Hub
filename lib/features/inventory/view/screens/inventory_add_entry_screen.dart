...
class InventoryAddEntryScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<InventoryAddEntryScreen> createState() =>
      _InventoryAddEntryScreenState();
}

class _InventoryAddEntryScreenState extends ConsumerState<InventoryAddEntryScreen> {
  int _currentStep = 0;
  ...
  void initState() {
    ...
    // Initial Variety pre-population matching Category default
