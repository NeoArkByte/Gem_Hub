...
class MarketplaceCategories extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool isDark = Theme.of(context).brightness == Brightness.dark;
    final categories = ['All Jobs', 'Cutter', 'Polisher', 'Sales', 'Expert'];
...
class MarketplaceBottomNav extends StatelessWidget {
  const MarketplaceBottomNav({Key? key}) : super(key: key);
